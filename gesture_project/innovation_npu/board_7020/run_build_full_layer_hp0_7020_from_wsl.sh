...
cp -f "$root"/rtl/{gestureflow_line_delay_bank,gestureflow_line_window,gestureflow_same4x4_rgb_window,gestureflow_weight_bank,gestureflow_mac_tile,gestureflow_conv4x4_rgb_same_stream,gestureflow_requant_relu,gestureflow_output_bank,gestureflow_conv4x4_rgb_same_layer,gestureflow_hp0_rgb_loader,gestureflow_hp0_tensor_writer,gestureflow_full_layer_hp0_axil}.sv "$dst/gestureflow_src/"
cp -f "$board/build_gestureflow_full_layer_hp0_7020.tcl" "$dst/project_local_gestureflow/"
cmd.exe /d /s /c "pushd E:\coralnpu_vivado\projects\gestureflow_full_layer_hp0_7020_v1\project_local_gestureflow && call E:\Xilinx\Vivado\2023.2\bin\vivado.bat -mode batch -source E:\coralnpu_vivado\projects\gestureflow_full_layer_hp0_7020_v1\project_local_gestureflow\build_gestureflow_full_layer_hp0_7020.tcl"

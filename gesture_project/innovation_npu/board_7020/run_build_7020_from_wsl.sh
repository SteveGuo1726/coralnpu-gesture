...
cp -f "$root/rtl/gestureflow_activation_bank.sv" "$root/rtl/gestureflow_weight_bank.sv" "$root/rtl/gestureflow_mac_tile.sv" "$root/rtl/gestureflow_axil_microkernel.sv" "$dst/gestureflow_src/"

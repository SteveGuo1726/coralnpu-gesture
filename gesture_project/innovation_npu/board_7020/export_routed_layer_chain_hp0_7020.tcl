...
# Export implementation evidence from an already-routed local GestureFlow design.
...
write_hw_platform -fixed -include_bit -force -file [file join $logs_dir gestureflow_layer_chain_hp0_7020.xsa]
close_design
exit

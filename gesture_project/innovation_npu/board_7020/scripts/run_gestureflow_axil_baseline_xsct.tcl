...
set project_root "E:/coralnpu_vivado/projects/gestureflow_axil_baseline_7020_v1"
set bit_path [file join $project_root axi_gpio.runs impl_1 system_wrapper.bit]
set xsa_path [file join $project_root logs gestureflow_axil_7020.xsa]
set ps7_init_path [file join $project_root axi_gpio.srcs sources_1 bd system ip system_processing_system7_0_0 ps7_init.tcl]
set elf_path [file join $project_root vitis axi_gpio Debug gestureflow_axil_smoke.elf]
set probe_base 0xFFFF0000

# Windows reserves 3103-3202 on this WSL2 host, including the conventional
# hw_server port 3121. hw_server is explicitly started on 3333 instead.
...
puts "GESTUREFLOW_AXIL_BOARD_PASS"
disconnect
exit

...
gap_fc_header="$root/board_7020/software/gestureflow_real_gap_fc.h"
dst=/mnt/e/coralnpu_vivado/projects/gestureflow_layer_chain_hp0_7020_v1
app="$dst/vitis/axi_gpio"
fast_release="${GF_FAST_RELEASE:-1}"

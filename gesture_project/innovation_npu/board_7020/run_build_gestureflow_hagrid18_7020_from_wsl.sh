...
cd /mnt/e
timeout 1200s cmd.exe /d /s /c "pushd E:\\coralnpu_vivado\\projects\\gestureflow_hagrid18_7020_v1\\project_local_gestureflow && call E:\\Xilinx\\Vivado\\2023.2\\bin\\vivado.bat -mode batch -source build_gestureflow_hagrid18_7020.tcl" 2>&1 | tee /tmp/gestureflow_hagrid18_full_build.log

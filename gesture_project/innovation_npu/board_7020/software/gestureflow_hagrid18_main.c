...
int main(void)
{
    ...
    config_tile_params(0U, gf_body2_folded_bias, gf_body2_requant_multiplier, gf_body2_requant_right_shift, 16U, 16U);
    wait_layer_done();
    ...
    config_tile_params(0U, gf_conv2a_folded_bias, gf_conv2a_requant_multiplier, gf_conv2a_requant_right_shift, GF_CONV2A_OUTPUT_LANES, 32U);
    wait_layer_done();
    ...
    config_tile_params(0U, gf_conv2b_folded_bias, gf_conv2b_requant_multiplier, gf_conv2b_requant_right_shift, GF_CONV2B_OUTPUT_LANES, 32U);
    wait_layer_done();
    ...
    config_tile_params(0U, gf_conv3a_folded_bias, gf_conv3a_requant_multiplier, gf_conv3a_requant_right_shift, GF_CONV3A_OUTPUT_LANES, 32U);
    wait_layer_done();
    ...
    config_tile_params(32U, gf_conv3a_folded_bias, gf_conv3a_requant_multiplier, gf_conv3a_requant_right_shift, GF_CONV3A_OUTPUT_LANES, 16U);
    wait_layer_done();
    ...
    config_tile_params(0U, gf_conv3b_folded_bias, gf_conv3b_requant_multiplier, gf_conv3b_requant_right_shift, GF_CONV3B_OUTPUT_LANES, 32U);
    wait_layer_done();
    ...
    config_tile_params(32U, gf_conv3b_folded_bias, gf_conv3b_requant_multiplier, gf_conv3b_requant_right_shift, GF_CONV3B_OUTPUT_LANES, 16U);
    wait_layer_done();

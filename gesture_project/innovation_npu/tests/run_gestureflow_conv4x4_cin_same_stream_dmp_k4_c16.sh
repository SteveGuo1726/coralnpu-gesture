...
build_dir="${TMPDIR:-/tmp}/gestureflow_conv4x4_cin_same_stream_dmp_k4_c16_verilator"
...
VERILATOR_ROOT="$verilator_root" verilator --binary --timing --sv \
  --top-module tb_gestureflow_conv4x4_cin_same_stream_dmp_k4_c16 \
  --Mdir "$build_dir" \
  ...
  "$root/tests/tb_gestureflow_conv4x4_cin_same_stream_dmp_k4_c16.sv"
"$build_dir/Vtb_gestureflow_conv4x4_cin_same_stream_dmp_k4_c16"

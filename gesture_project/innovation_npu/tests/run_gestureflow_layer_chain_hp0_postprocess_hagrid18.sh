...
build="${TMPDIR:-/tmp}/gestureflow_layer_chain_hp0_postprocess_hagrid18_verilator"
rm -rf "$build"
VERILATOR_ROOT=/home/steveguo/verilator /home/steveguo/verilator/bin/verilator_bin --binary --timing --sv -Wno-fatal \
  --top-module tb_gestureflow_layer_chain_hp0_postprocess_hagrid18 --Mdir "$build" \
  ...
  "$root/tests/tb_gestureflow_layer_chain_hp0_postprocess_hagrid18.sv"
timeout 180s "$build/Vtb_gestureflow_layer_chain_hp0_postprocess_hagrid18"

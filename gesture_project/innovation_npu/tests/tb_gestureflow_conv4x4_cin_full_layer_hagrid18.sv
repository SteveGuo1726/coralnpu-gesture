...
// Full real second convolution regression for the HaGRID-18 distilled
// student (16->16, 96x96). Same engine path as the 6-class body2 layer.
`timescale 1ns/1ps
module tb_gestureflow_conv4x4_cin_full_layer_hagrid18;
  `include "generated_gestureflow_real_conv4x4_body2_hagrid18_layer.svh"

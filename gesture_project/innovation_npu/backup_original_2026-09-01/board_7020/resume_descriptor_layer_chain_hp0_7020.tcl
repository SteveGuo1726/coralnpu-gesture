...
# Descriptor-only implementation resume.  Synthesis has already completed in
# this isolated project; do not reset synth_1 and do not touch the writer-burst
# rollback project.
...
if {[get_property PROGRESS $impl_run] ne "100%"} {
  error "Descriptor implementation failed: [get_property STATUS $impl_run]"
}
open_run $impl_run
...
puts "GESTUREFLOW_LAYER_CHAIN_DESCRIPTOR_HP0_7020_IMPLEMENTATION_PASS project=$project_root"
close_project
exit

...
# This build is physically isolated from the signed 40-Cin descriptor project.
root="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
dst=/mnt/e/coralnpu_vivado/projects/gestureflow_wide80_7020_v1
...
cp -f "$root/board_7020/build_gestureflow_wide80_7020.tcl" "$dst/project_local_gestureflow/"
timeout 300s cmd.exe /d /s /c "pushd E:\\coralnpu_vivado\\projects\\gestureflow_wide80_7020_v1\\project_local_gestureflow && call E:\\Xilinx\\Vivado\\2023.2\\bin\\vivado.bat -mode batch -source build_gestureflow_wide80_7020.tcl" 2>&1 | tee /tmp/gestureflow_wide80_full_build_20260825_postprocess.log

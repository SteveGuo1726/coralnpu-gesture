...
set_property -dict [list CONFIG.MAX_INPUT_CHANNELS {40} CONFIG.OUT_LANES {16} CONFIG.POOL_BANK_ADDR_W {14} CONFIG.ENABLE_WIDE_MODES {1} CONFIG.ENABLE_POSTPROCESS {0} CONFIG.ENABLE_RELAY {0} CONFIG.ENABLE_STREAM_STORE {0}] [get_bd_cells gestureflow_0]

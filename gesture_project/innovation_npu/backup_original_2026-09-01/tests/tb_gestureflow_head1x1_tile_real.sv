...
// current 7020 static-network tail. This is the concrete bridge between the
// hybrid344 algorithm line and the new generic 1x1 hardware path.
`timescale 1ns/1ps
module tb_gestureflow_head1x1_tile_real;
  ...
  initial begin
    ...
    $display("GESTUREFLOW_HEAD1X1_TILE_REAL_PASS outputs=%0d probes=%0d hash=%08x",

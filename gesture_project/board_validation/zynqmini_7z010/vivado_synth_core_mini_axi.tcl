...
set out_root "E:/coralnpu_vivado/zynqmini_7z010/core_mini_axi"
set report_root "$repo_root/gesture_project/board_validation/zynqmini_7z010/reports"

file mkdir $out_root
file mkdir $report_root

create_project -force core_mini_axi $out_root -part $part_name
...
report_utilization -file "$report_root/core_mini_axi_utilization_synth.rpt"
report_timing_summary -file "$report_root/core_mini_axi_timing_synth.rpt"
report_drc -file "$report_root/core_mini_axi_drc_synth.rpt"
write_checkpoint -force "$out_root/core_mini_axi_synth.dcp"

puts "CORE_MINI_AXI_7Z010_SYNTH_PASS"

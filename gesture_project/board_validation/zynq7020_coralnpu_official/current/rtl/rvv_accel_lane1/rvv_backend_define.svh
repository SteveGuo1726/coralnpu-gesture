...
// PROJECT_LOCAL_MOD: this project-local rvv_accel_lane1 tree is a
// convolution-focused accelerator cut. We keep the MAC/VRF/LSU path first and
// temporarily disable PMTRDT/DIV execution-side hardware to recover LUT budget.
`define PROJECT_LOCAL_CONV_ACCEL_ONLY
...
`else  // DISPATCH2
  ...
  `define PMTRDT_RS_DEPTH       2
  `define MUL_RS_DEPTH          2
  `define DIV_RS_DEPTH          2
  `define FALU_RS_DEPTH         2
  `define FRDT_RS_DEPTH         2
  `define LSU_RS_DEPTH          2
  `define LSUMAP_DEPTH          2
  `define ROB_DEPTH             4
`endif

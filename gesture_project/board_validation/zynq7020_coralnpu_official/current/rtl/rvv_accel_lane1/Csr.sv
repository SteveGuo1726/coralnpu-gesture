...
module Csr(
  ...
  input  [2:0]  io_counters_nRetired,
  output        io_halted,
                io_fault,
                io_wfi,
  input         io_irq,
  ...
  wire [2:0]  _minstretThisCycle_delayed_T;
  reg         req_valid;
  ...
  reg  [63:0] mcycle;
  reg  [63:0] minstret;
  wire [63:0] _minstret_T = minstret + {61'h0, _minstretThisCycle_delayed_T};
  ...
  wire [31:0] _rdata_T_206 =
    ...
    | (mstatusEn ? {24'h1A, mstatus_mpie, 3'h0, mstatus_mie, 3'h0} : 32'h0)
    | (misaEn ? 32'h40201100 : 32'h0) | (mieEn ? mie : 32'h0)
    ...
    | (kscm0En ? 32'hA3CD5052 : 32'h0) | (kscm1En ? 32'h7414391A : 32'h0)
    | (kscm2En ? 32'h81BBE178 : 32'h0) | (kscm3En ? 32'hA94C0AC0 : 32'h0)
    | (kscm4En ? 32'h7318DFC2 : 32'h0);
  ...
  assign _minstretThisCycle_delayed_T =
    minstret_written_delayed ? 3'h0 : io_counters_nRetired;
